 ...
 * @author Simon
 */
public class LogoutClient extends javax.swing.JDialog {

    /**
     * Creates new form LogoutClient
     */
    ...
    public LogoutClient(java.awt.Frame parent, boolean modal, Socket s) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Button_Deconnexion.setText("Déconnexion");
        Button_Deconnexion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Button_DeconnexionActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(Button_Deconnexion, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Button_Deconnexion)
    ...
    private void Button_DeconnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_DeconnexionActionPerformed
        ...
        else
        {
            ...
            RequeteSUM req = new RequeteSUM(RequeteSUM.REQUEST_LOGOUT, chargeUtile);
            ...
            if(rep.getCode() == ReponseSUM.LOGOUT_OK)
            {                
                this.dispose();
            }
            else
            {
                JOptionPane.showMessageDialog(new JFrame(), "Erreur dans la déconnexion réessayer !", "Erreur", JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_Button_DeconnexionActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogoutClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LogoutClient dialog = new LogoutClient(new javax.swing.JFrame(), true, null);
